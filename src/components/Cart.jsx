...
const Cart = () => {
 ...
 const handleRemove = (product) =>{
  const findProduct = cart.filter(pd => pd.id !== product.id);
  setCart(findProduct)
  removeFromDb(product.id);
  toast.warning('Successfully Removed' , {autoClose:500})
 }
 let total = 0;
 ...
 const placeOrder = () =>{
  ...
  toast.success('Successfully Order Placed' , {autoClose:500})
 }
  return (
